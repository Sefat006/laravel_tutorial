                ...
                <div class="col-md-3 top_right_menu text-end">
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a  href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-item" href="#"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                ...
                <div class="col-md-2 sidebar_part">
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="{{route('user.all')}}"><i class="fas fa-user-circle"></i> Users</a></li>
                            <li><a href="{{ route('banner.all') }}"><i class="fas fa-images"></i> Banner</a></li>
